...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildCategoriesList() {
    ...
    return Row(
      ...
      children: <Widget>[
      IconButton(
        icon: Image.asset('assets/images/fruits.png'),
        color: Colors.black,
        iconSize: 50,
  ...
  Widget _buildShowPlantsList() {
    List topProductList = [
      TopProductTile(
        assetPath: 'assets/images/snakePlant.png',
        color: Color(0xffDFECF8),
        price: '\₹20.00',
        title: 'Bonsai',
      ),
      ...
      TopProductTile(
        color: Color(0xffFFF2C5),
        assetPath: 'assets/images/spiderPlant.png',
        title: 'Spider plant',
        price: '\₹50.00',
      ),
      TopProductTile(
